...
Pour lire et extraires les données à partir de ces fichiers en structure XML, nous avons utilisé un job ![New data](./image/Job%20parent.png "Talend job 2021-Now")
