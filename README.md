...
Dans notre projet, l'apprentissage automatique a été faite sur les données historique le but étant de prédire la qualité d'aire dee 2024.
Ces étapes sont décrites dans le scripe  [Machine_LearningFR.ipynb](./Notebook/Machine_LearningFR.ipynb).
